                    ...
                    if checkFields != nil {
                        ...
                        Auth.auth().createUser(withEmail: email, password: password) { result, err in
                            ...
                            if err != nil {
                                ...
                                dataBase.collection("users").addDocument(data: ["userName":  userName, "uid": result!.user.uid, "bio": "", "moviesLiked": [], "moviesDisliked": [], "friends": [], "profilePicture": "https://firebasestorage.googleapis.com/v0/b/flickpick-65318.appspot.com/o/defaultUser.png?alt=media&token=7d6663ac-daa4-4e71-b319-1b7c6e3d56cb"]) { error in
